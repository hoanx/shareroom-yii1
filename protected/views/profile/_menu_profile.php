...
<div class="profile-menu">
    <ul>
        ...
        <?php if ($controller_name == 'profile' && $action_name == 'my_booking'): ?>
            <li><?php echo CHtml::link(Yii::t('app', 'đặt phòng của tôi'), array('profile/my_booking'), array('class' => 'btn btn-info active')) ?></li>
        <?php else: ?>
            <li><?php echo CHtml::link(Yii::t('app', 'đặt phòng của tôi'), array('profile/my_booking'), array('class' => 'btn btn-info')) ?></li>
        <?php endif; ?>
