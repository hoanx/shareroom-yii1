        ...
        if(Yii::app()->user->hasState('paymentData')){
            ...
            if(isset($_POST['submit']) && $_POST['submit']=='Sử dụng'){
                ...
                if($validateBooking && $validateBookingUser){
                    ...
                    $messages->content = 'Chúc mừng! Bạn có một yêu cầu đặt phòng! Vui lòng xem xét kỹ yêu cầu đặt phòng của bạn. Nếu bạn có bất kỳ thắc mắc nào, hãy gửi tin nhắn cho khách trước khi chấp nhận việc đặt phòng.';
