 ...
 *
 * The followings are the available columns in table 'tb_wishlist':
 * @property integer $id
...
class Wishlist extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, room_address_id', 'required'),
			array('user_id, room_address_id, del_flg', 'numerical', 'integerOnly'=>true),
			array('created, updated', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, room_address_id, created, updated, del_flg', 'safe', 'on'=>'search'),
		);
	}
