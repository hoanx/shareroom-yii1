...
class RoomPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('room_address_id, min_nights, max_nights, cancellation', 'numerical', 'integerOnly'=>true),
			array('price, weekly, monthly, additional_guests, cleaning_fees', 'numerical'),
			array('price, weekly, monthly, additional_guests, cleaning_fees, min_nights,
			    max_nights, cancellation, house_rules, created, updated', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, room_address_id, price, weekly, monthly, additional_guests, cleaning_fees, min_nights, max_nights, check_in, check_out, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'check_in' => Yii::t('app', 'Thời gian nhận phòng'),
			'check_out' => Yii::t('app', 'Thời gian trả phòng'),
			'created' => 'Created',
			'updated' => 'Updated',
		);
	}
